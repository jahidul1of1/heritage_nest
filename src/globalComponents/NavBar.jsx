...
const navigation2 = [
  { name: "Manage Rentals", href: "", current: true },
...
export default function NavBar() {
  return (
    <Disclosure as="nav" className="bg-[#ECF5FF] sticky top-0 z-50">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-[1600px] px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-black  hover:text-black/70 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-center sm:justify-between">
                ...
                <div className="h-14 hidden sm:ml-6 sm:block w-auto">
                  <img
                    src={logo}
                    alt=""
